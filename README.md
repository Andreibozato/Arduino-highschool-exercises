...
<details>
  ...
  - **Objective:** Reads the ambient temperature with the LM35 sensor, displays the value in degrees Celsius on the LCD (with the °C symbol), and turns on a blue LED if the temperature is ≥22°C or a red LED otherwise, updating every 300 ms.
